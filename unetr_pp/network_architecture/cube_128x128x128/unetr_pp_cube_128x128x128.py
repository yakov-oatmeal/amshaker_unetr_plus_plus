...
from unetr_pp.network_architecture.cube_128x128x128.model_components import UnetrPPEncoder, UnetrUpBlock
...
class UNETR_PP(SegmentationNetwork):
    ...
    def forward(self, x_in):
        ...
        print(f"LOGITS = FINAL UNET OUT {logits[0].shape}")
